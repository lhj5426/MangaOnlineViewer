// ==UserScript==
// @name          Manga OnlineViewer Adult 260227AI魔改 强下补漏优化界面粘贴改完追加模式
// @author        Tago
        ...
        <div id="pageInputGroup">
          ...
          <div style="margin-top: 15px; padding: 15px; background: #fff3cd; border: 2px solid #ffc107; border-radius: 8px;">
            <div style="display: block;">
              ...
              <div id="importStatus" style="font-size: 13px; text-align: center; display: none; margin-top: 8px; padding: 8px; border-radius: 4px; line-height: 1.6;">
              </div>
              <div style="margin-top: 10px;">
                ...
                <div id="pasteStatus" style="font-size: 13px; text-align: center; display: none; margin-top: 5px; padding: 5px; border-radius: 4px; line-height: 1.4;"></div>
              </div>
            </div>
          </div>
        </div>
