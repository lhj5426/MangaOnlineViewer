// ==UserScript==
// @name          Manga OnlineViewer Adult 260222AI魔改 计算批次快速填入
// @author        Tago
            ...
            for (let i = 0; i < divide; i++) {
              ...
              if (batchStart <= end) {
                ...
                if (i === 0 && batchEnd < end) {
                  ...
                  batchBtn = `<button class="batch-autofill-btn" data-start="${batchStart}" data-count="${pageCount}" style="margin-left: 8px; padding: 6px 16px; background: #FF9800; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 13px; font-weight: bold; transition: all 0.2s;">填入</button>`;
                }
