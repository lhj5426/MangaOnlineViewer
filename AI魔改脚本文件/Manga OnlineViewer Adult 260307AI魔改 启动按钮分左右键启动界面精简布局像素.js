// ==UserScript==
// @name          Manga OnlineViewer Adult 260307AI魔改 启动按钮分左右键启动界面精简布局像素
// @author        Tago
...
(function () {
  ...
  function createLateStartButton(site, beginning) {
    ...
    button.id = 'StartMOV';
    button.title = '左键：无界面快速启动\n右键：打开启动界面';
    
    // 左键点击：直接以默认设置快速启动（不弹窗）
    ...
    logScript('Start Button added to page (Left: Quick Start, Right: Settings)', button);
  }
